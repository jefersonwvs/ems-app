  ...
  <script>
    $(document).ready(function() {
      ...
      $('#deleteBtn').click(function() {
        ...
        const employeeIds = deletedEmployees.toString();
    ...
    <table class="table table-striped table-hover">
      ...
      <c:forEach var="employee" items="${employees}">
        <tr>
          <td>
            <span class="custom-checkbox">
              <input type="checkbox" id="${employee.id}" value="${employee.id}" class="employeeCheck">
...
<!-- Delete Modal HTML -->
<jsp:include page="deleteEmployeeView.jsp" />
</body>
